...
void main() async {
  ...
  // Firestore.instance.collection("mensagens").document().collection("arqmidia").document().setData({"from": "Juliana", "texto": "Tudo bem?"});

/*   DocumentSnapshot snapshot = await Firestore.instance.collection("usuario").document("Juliana56").get();
  print(snapshot.data); */
